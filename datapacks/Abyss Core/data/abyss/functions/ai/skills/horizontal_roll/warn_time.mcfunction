...
execute if score warn_time boss matches 25.. run schedule function abyss:ai/skills/horizontal_roll/go_through 1t
execute unless score warn_time boss matches 25.. run schedule function abyss:ai/skills/horizontal_roll/warn_time 1t
...
execute store result storage abyss:data tangle.node.2[0] double 0.001 run scoreboard players get #b3 boss
execute store result storage abyss:data tangle.node.4[0] double 0.001 run scoreboard players get #b4 boss

scoreboard players add #b5 boss 60
execute store result storage abyss:data tangle.node.3[2] double 0.001 run scoreboard players get #b5 boss

scoreboard players add #b35 boss 90

execute store result storage abyss:data tangle.node.2[2] double 0.001 run scoreboard players get #b35 boss
execute store result storage abyss:data tangle.node.4[2] double 0.001 run scoreboard players get #b35 boss